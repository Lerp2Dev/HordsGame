...
public class Bullet : MonoBehaviour
{
    ...
    private WeaponInfo weaponInfo = new WeaponInfo(); // damage and owner name sent to hit object
   ...
   // Update is called once per frame
    ...
    protected virtual void OnHit(RaycastHit hit)
    {
       ...
       { 
            ...
            weaponInfo.owner = owner;        // tell hit object who hit them
            weaponInfo.damage = damage; // tell them how much damage they recieved
            // send the message
            hit.collider.SendMessageUpwards("ImHit", weaponInfo, SendMessageOptions.DontRequireReceiver);
